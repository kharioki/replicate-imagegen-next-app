    ...
    <div className="p-8 text-xl max-w-3xl mx-auto">
      ...
      <form className="flex mb-8" onSubmit={handleSubmit}>
        <input
          ...
          className="w-full p-4 border border-gray-300 rounded-lg mr-4 text-xl"
        />
        <button type="submit" className="p-4 border-0 rounded-md box-border cursor-pointer text-xl bg-slate-800">Go!</button>
      </form>
